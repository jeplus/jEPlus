 ...
 * @author Yi
 */
public class EsoDataRecordRunPeriod {
    int DictItemID = 1;
    String [] Values;
    
    public EsoDataRecordRunPeriod () {}
    ...
    public static EsoDataRecordRunPeriod getEsoDataRecordRunPeriod (EsoDataDictionaryItem dict, String [] textparts) {
        EsoDataRecordRunPeriod item = new EsoDataRecordRunPeriod();
