...
public class RVX_ESOitem implements Serializable, IF_RVXItem {
    ...
    public String toString () {
        return TableName + ":" + Variables.size() + " variables (" + Frequency + ")" + (UsedInCalc ? "" : "*");
    }
    ...
    public boolean equals(Object obj) {
        ...
        final RVX_ESOitem other = (RVX_ESOitem) obj;
        if (this.UsedInCalc != other.UsedInCalc) {
            return false;
        }
        if (! new HashSet<>(this.Variables).equals(new HashSet<>(other.Variables))) {
            return false;
        }
    ...
    public void copyFrom(IF_RVXItem item) {
        try {
            RVX_ESOitem src = (RVX_ESOitem)item;
