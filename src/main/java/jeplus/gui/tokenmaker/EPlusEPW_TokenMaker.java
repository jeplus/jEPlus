 ...
 * @author Yi
 */
public class EPlusEPW_TokenMaker extends AbstractTokenMaker {
    ...
    public TokenMap getWordsToHighlight() {
        ...
        tokenMap.put("LOCATION", Token.RESERVED_WORD);
        tokenMap.put("DESIGN", Token.RESERVED_WORD);
        tokenMap.put("CONDITIONS", Token.RESERVED_WORD);
        tokenMap.put("TYPICAL/EXTREME", Token.RESERVED_WORD);
        tokenMap.put("PERIODS", Token.RESERVED_WORD);
        tokenMap.put("GROUND", Token.RESERVED_WORD);
        tokenMap.put("TEMPERATURES", Token.RESERVED_WORD);
        tokenMap.put("HOLIDAYS/DAYLIGHT", Token.RESERVED_WORD);
        tokenMap.put("SAVINGS", Token.RESERVED_WORD);
        tokenMap.put("COMMENTS", Token.RESERVED_WORD);
