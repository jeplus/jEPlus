 ...
 * Class Error
 */
public class SimpleParserError extends Exception {
     ...
     */
    SimpleParserError(final int id, final String str) {
        row_ = -1;
        col_ = -1;
        id_ = id;
     ...
     * @PARAM id id of the message
     */
    SimpleParserError(final int id) {
        row_ = -1;
        col_ = -1;
        id_ = id;
     ...
     * @PARAM str a string which will be filled in in the message
     */
    SimpleParserError(final int row, final int col, final int id, final String str) {
        row_ = row;
        col_ = col;
        id_ = id;
     ...
     * @PARAM id id of the message
     */
    SimpleParserError(final int row, final int col, final int id) {
        row_ = row;
        col_ = col;
        id_ = id;
...
/// Private functions
    /**
     * Returns a pointer to the message description for the given message id. Returns "Unknown error" if id was not recognized.
     */
